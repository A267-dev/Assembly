...
{
	public class FourthGenSimulationDefinitionTable : ISimulationDefinitionTable
	{
		...
		public FourthGenSimulationDefinitionTable(ITag scenario, TagTable tags, IReader reader, FileSegmentGroup metaArea, MetaAllocator allocator, EngineDescription buildInfo, IPointerExpander expander)
		{
			_scenario = scenario;
			_tags = tags;
			_metaArea = metaArea;
