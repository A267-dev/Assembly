...
{
	/// <summary>
	///     Implementation of <see cref="IZoneSet" /> for Fourth-generation cache files.
	/// </summary>
	public class FourthGenZoneSet : IZoneSet
	{
		...
		public FourthGenZoneSet(StructureValueCollection values, IReader reader, FileSegmentGroup metaArea, IPointerExpander expander)
		{
			_metaArea = metaArea;
