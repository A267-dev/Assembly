...
namespace Blamite.Blam.FourthGen.Resources.BSP
{
	public class FourthGenScenarioBSP : IScenarioBSP
	{
		public FourthGenScenarioBSP(StructureValueCollection values, IReader reader, FileSegmentGroup metaArea,
