...
{
	/// <summary>
	/// Streams shader data in Fourth-gen cache files.
	/// </summary>
	class FourthGenShaderStreamer : IShaderStreamer
	{
		...
		public FourthGenShaderStreamer(ICacheFile cacheFile, EngineDescription desc)
		{
		...
		public IShader ReadShader(IReader reader, ShaderType type)
		{
			...
			return new FourthGenShader(type, microcode, info.DatabasePath);
		}
