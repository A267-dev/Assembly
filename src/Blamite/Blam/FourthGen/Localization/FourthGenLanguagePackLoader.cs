...
{
	/// <summary>
	/// Implementation of <see cref="ILanguagePackLoader" /> for Fourth-generation engines.
	/// </summary>
	public class FourthGenLanguagePackLoader : ILanguagePackLoader
	{
		private readonly Dictionary<ITag, FourthGenMultilingualStringList> _groupsByTag = new Dictionary<ITag, FourthGenMultilingualStringList>();
		private readonly FourthGenLanguageGlobals _languageGlobals;
		...
		/// </summary>
		public FourthGenLanguagePackLoader()
		{
		...
		private void LoadGroups(IReader reader, ICacheFile cacheFile)
		{
			...
			{
				var group = new FourthGenMultilingualStringList(reader, tag, _buildInfo);
		...
		/// <summary>
		/// Creates a <see cref="LocalizedStringList"/> from a <see cref="FourthGenMultilingualStringList"/>.
		/// </summary>
		...
		private static LocalizedStringList CreateList(FourthGenMultilingualStringList group, int languageIndex, List<LocalizedString> table)
		{
