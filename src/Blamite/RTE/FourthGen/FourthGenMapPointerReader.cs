...
{
	public class FourthGenMapPointerReader : MapPointerReader
	{
		public FourthGenMapPointerReader(ProcessMemoryStream stream, EngineDescription engineInfo, PokingInformation info)
		{
		...
		public FourthGenMapPointerReader(ProcessModuleMemoryStream stream, EngineDescription engineInfo, PokingInformation info)
		{
